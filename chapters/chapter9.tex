...
\begin{enumerate}
  ...
  \begin{enumerate}
    \begin{figure}[H]
      \centering
      \begin{tikzpicture}
        \tkzDefPoints{0/0/Q, 5.5/0/R, 5.5/2.5/P, 8/2/L}
    ...
    \item[]\mbox{}
      ...
      $QR = 12$ cm
      \newpage
    \item Find the size of the angle marked $x$. Give your answer correct to 1 decimal place.\mrk{3}\\[3.5cm]\vspace*{0pt}\hfill\dline $^\circ$
  \end{enumerate}
