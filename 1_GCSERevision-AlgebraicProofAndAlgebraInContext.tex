...
\begin{document}
	...
	\begin{questions}
		...
		\begin{parts}
			\part[2] Show that $2x^2 + x - 351 = 0$.
			\vspace{\stretch{1}}

			\part[3] Work out the value of $x$.
			\vspace{\stretch{1}}
		\end{parts}
		...
		\question Prove algebraically that the difference between the squares of any two consecutive integers is equal to the sum of these two integers.
		\vspace{\stretch{1}}
		...
		\question Umar thinks $(a + 1)^2 = a^2 + 1$ for all values of $a$.
		\begin{parts}
			\part[2] Show that Umar is wrong.
			\vspace{\stretch{1}}
			...
			\end{figure}
			%
			\part[3] Show that $2a + 2b + 1 = 2c$\\
			\vspace{\stretch{1}}
			$a,\ b$ and $c$ cannot all be integers.

			\part[1] Explain why.\\
			\vspace{\stretch{1}}
			\hfill\textbf{(Total 6 marks)}
		\end{parts}
		
		\clearpage
		\question The diagram below shows a large rectangle of length $(2x + 6)$ cm and width $x$ cm. A smaller rectangle of length $x$ cm and width $3$ cm is cut out and removed.
		...
		\begin{parts}
			\part[3] Show that $2x^2 + 3x - 100 = 0$.
			\vspace{\stretch{1}}

			\part[4] Calculate the length of the smaller rectangle.\\
			Give your answer correct to $3$ significant figures.\\
			\vspace{\stretch{1}}
			\hfill\textbf{(Total 7 marks)}
		\end{parts}
		...
		\begin{parts}
			\part[3] Show that $x^2 - 4x - 12 = 0$
			\vspace{\stretch{1}}
			%
			\part[4]
			\begin{subparts}
				\subpart Solve $x^2 - 4x - 12 = 0$
				\vspace{\stretch{1}}

				\subpart Hence, write down the length of $AC$.
				\vspace{\stretch{1}}
			\end{subparts}
		\end{parts}
		\hfill\textbf{(Total 7 marks)}
